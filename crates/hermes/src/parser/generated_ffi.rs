...
extern "C" {
    ...
    pub fn hermes_get_BlockStatement_implicit(node: NodePtr) -> bool;
    // StaticBlock
    ...
    pub fn hermes_get_ImportExpression_options(node: NodePtr) -> NodePtrOpt;
    // CallExpression
    ...
    // Decorator
    pub fn hermes_get_Decorator_expression(node: NodePtr) -> NodePtr;
    // ClassDeclaration
    ...
    pub fn hermes_get_ClassDeclaration_superTypeArguments(node: NodePtr) -> NodePtrOpt;
    ...
    pub fn hermes_get_ClassExpression_superTypeArguments(node: NodePtr) -> NodePtrOpt;
    ...
    pub fn hermes_get_ClassProperty_decorators(node: NodePtr) -> NodeListRef;
    ...
    pub fn hermes_get_ClassPrivateProperty_decorators(node: NodePtr) -> NodeListRef;
    ...
    pub fn hermes_get_MethodDefinition_decorators(node: NodePtr) -> NodeListRef;
    // ImportDeclaration
    ...
    // MatchInstancePattern
    pub fn hermes_get_MatchInstancePattern_targetConstructor(node: NodePtr) -> NodePtr;
    pub fn hermes_get_MatchInstancePattern_properties(node: NodePtr) -> NodePtr;
    // MatchObjectPatternProperty
    ...
    // MatchInstanceObjectPattern
    pub fn hermes_get_MatchInstanceObjectPattern_properties(node: NodePtr) -> NodeListRef;
    pub fn hermes_get_MatchInstanceObjectPattern_rest(node: NodePtr) -> NodePtrOpt;
    // MatchRestPattern
    ...
    pub fn hermes_get_OpaqueType_lowerBound(node: NodePtr) -> NodePtrOpt;
    pub fn hermes_get_OpaqueType_upperBound(node: NodePtr) -> NodePtrOpt;
    ...
    pub fn hermes_get_DeclareOpaqueType_lowerBound(node: NodePtr) -> NodePtrOpt;
    pub fn hermes_get_DeclareOpaqueType_upperBound(node: NodePtr) -> NodePtrOpt;
    ...
    // RecordDeclaration
    pub fn hermes_get_RecordDeclaration_id(node: NodePtr) -> NodePtr;
    pub fn hermes_get_RecordDeclaration_typeParameters(node: NodePtr) -> NodePtrOpt;
    pub fn hermes_get_RecordDeclaration_implements(node: NodePtr) -> NodeListRef;
    pub fn hermes_get_RecordDeclaration_body(node: NodePtr) -> NodePtr;
    // RecordDeclarationImplements
    pub fn hermes_get_RecordDeclarationImplements_id(node: NodePtr) -> NodePtr;
    pub fn hermes_get_RecordDeclarationImplements_typeArguments(node: NodePtr) -> NodePtrOpt;
    // RecordDeclarationBody
    pub fn hermes_get_RecordDeclarationBody_elements(node: NodePtr) -> NodeListRef;
    // RecordDeclarationProperty
    pub fn hermes_get_RecordDeclarationProperty_key(node: NodePtr) -> NodePtr;
    pub fn hermes_get_RecordDeclarationProperty_typeAnnotation(node: NodePtr) -> NodePtr;
    pub fn hermes_get_RecordDeclarationProperty_defaultValue(node: NodePtr) -> NodePtrOpt;
    // RecordDeclarationStaticProperty
    pub fn hermes_get_RecordDeclarationStaticProperty_key(node: NodePtr) -> NodePtr;
    pub fn hermes_get_RecordDeclarationStaticProperty_typeAnnotation(node: NodePtr) -> NodePtr;
    pub fn hermes_get_RecordDeclarationStaticProperty_value(node: NodePtr) -> NodePtr;
    // RecordExpression
    pub fn hermes_get_RecordExpression_recordConstructor(node: NodePtr) -> NodePtr;
    pub fn hermes_get_RecordExpression_typeArguments(node: NodePtr) -> NodePtrOpt;
    pub fn hermes_get_RecordExpression_properties(node: NodePtr) -> NodePtr;
    // RecordExpressionProperties
    pub fn hermes_get_RecordExpressionProperties_properties(node: NodePtr) -> NodeListRef;
    // TSTypeAnnotation
    ...
    // ImplicitCheckedCast
    pub fn hermes_get_ImplicitCheckedCast_argument(node: NodePtr) -> NodePtr;
}
