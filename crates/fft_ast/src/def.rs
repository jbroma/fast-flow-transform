    ...
    ($callback:ident) => {
        ...
        NodeKind {
            ...
            MatchStatement[Statement] {
                ...
                cases: NodeList<'a>[MatchStatementCase],
            },
            ...
            ClassBody {
                body: NodeList<'a>[ClassProperty, ClassPrivateProperty, MethodDefinition, StaticBlock],
            },
            ClassProperty {
            ...
            MatchStatementCase {
                pattern: &'a Node<'a>,
                body: &'a Node<'a>,
                guard: Option<&'a Node<'a>>,
            },
            MatchExpression[Expression] {
                argument: &'a Node<'a>[Expression],
                cases: NodeList<'a>[MatchExpressionCase],
            },
            MatchExpressionCase {
                pattern: &'a Node<'a>,
                body: &'a Node<'a>,
            ...
            DeclareNamespace[FlowDeclaration] {
                id: &'a Node<'a>[Identifier],
                body: &'a Node<'a>[BlockStatement],
            },
            ...
            AsExpression[FlowExpression] {
                expression: &'a Node<'a>[Expression],
                type_annotation: &'a Node<'a>[TypeAnnotation],
            },
            AsConstExpression[FlowExpression] {
                expression: &'a Node<'a>[Expression],
            },
            ...
            EnumBigIntBody[FlowEnumBody] {
                members: NodeList<'a>[EnumBigIntMember, EnumDefaultedMember],
                explicit_type: bool,
                has_unknown_members: bool,
            },
