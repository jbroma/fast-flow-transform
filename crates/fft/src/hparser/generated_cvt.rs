...
pub unsafe fn cvt_node_ptr<'parser, 'gc>(
    ...
    let res = match nr.kind {
        ...
        NodeKind::FunctionExpression => {
            ...
            let type_parameters =
                cvt_node_ptr_opt(cvt, gc, hermes_get_FunctionExpression_typeParameters(n));
            let return_type =
                cvt_node_ptr_opt(cvt, gc, hermes_get_FunctionExpression_returnType(n));
        ...
        NodeKind::ArrowFunctionExpression => {
            ...
            let type_parameters = cvt_node_ptr_opt(
                cvt,
                gc,
                hermes_get_ArrowFunctionExpression_typeParameters(n),
            );
            let return_type =
                cvt_node_ptr_opt(cvt, gc, hermes_get_ArrowFunctionExpression_returnType(n));
            let predicate =
                cvt_node_ptr_opt(cvt, gc, hermes_get_ArrowFunctionExpression_predicate(n));
        ...
        NodeKind::FunctionDeclaration => {
            ...
            let type_parameters =
                cvt_node_ptr_opt(cvt, gc, hermes_get_FunctionDeclaration_typeParameters(n));
            let return_type =
                cvt_node_ptr_opt(cvt, gc, hermes_get_FunctionDeclaration_returnType(n));
        ...
        NodeKind::ComponentDeclaration => {
            ...
            let type_parameters =
                cvt_node_ptr_opt(cvt, gc, hermes_get_ComponentDeclaration_typeParameters(n));
            let renders_type =
                cvt_node_ptr_opt(cvt, gc, hermes_get_ComponentDeclaration_rendersType(n));
        ...
        NodeKind::HookDeclaration => {
            ...
            let type_parameters =
                cvt_node_ptr_opt(cvt, gc, hermes_get_HookDeclaration_typeParameters(n));
        ...
        NodeKind::BlockStatement => {
            ...
            let implicit = hermes_get_BlockStatement_implicit(n);
        ...
        NodeKind::NewExpression => {
            ...
            let type_arguments =
                cvt_node_ptr_opt(cvt, gc, hermes_get_NewExpression_typeArguments(n));
        ...
        NodeKind::ImportExpression => {
            ...
            let options = cvt_node_ptr_opt(cvt, gc, hermes_get_ImportExpression_options(n));
        ...
        NodeKind::CallExpression => {
            ...
            let type_arguments =
                cvt_node_ptr_opt(cvt, gc, hermes_get_CallExpression_typeArguments(n));
        ...
        NodeKind::OptionalCallExpression => {
            ...
            let type_arguments =
                cvt_node_ptr_opt(cvt, gc, hermes_get_OptionalCallExpression_typeArguments(n));
        ...
        NodeKind::Identifier => {
            ...
            let type_annotation =
                cvt_node_ptr_opt(cvt, gc, hermes_get_Identifier_typeAnnotation(n));
        ...
        NodeKind::VariableDeclaration => {
            ...
            let declarations =
                cvt_node_list(cvt, gc, hermes_get_VariableDeclaration_declarations(n));
        ...
        NodeKind::Decorator => {
            let expression = cvt_node_ptr(cvt, gc, hermes_get_Decorator_expression(n));
            let mut template = ast::template::Decorator {
                metadata: ast::TemplateMetadata {
                    range,
                    ..Default::default()
                },
            ...
            ast::builder::Decorator::build_template(gc, template)
        }
        NodeKind::ClassDeclaration => {
            let id = cvt_node_ptr_opt(cvt, gc, hermes_get_ClassDeclaration_id(n));
            let type_parameters =
                cvt_node_ptr_opt(cvt, gc, hermes_get_ClassDeclaration_typeParameters(n));
            let super_class = cvt_node_ptr_opt(cvt, gc, hermes_get_ClassDeclaration_superClass(n));
            let super_type_arguments =
                cvt_node_ptr_opt(cvt, gc, hermes_get_ClassDeclaration_superTypeArguments(n));
        ...
        NodeKind::ClassExpression => {
            ...
            let type_parameters =
                cvt_node_ptr_opt(cvt, gc, hermes_get_ClassExpression_typeParameters(n));
            let super_class = cvt_node_ptr_opt(cvt, gc, hermes_get_ClassExpression_superClass(n));
            let super_type_arguments =
                cvt_node_ptr_opt(cvt, gc, hermes_get_ClassExpression_superTypeArguments(n));
        ...
        NodeKind::ClassProperty => {
            ...
            let decorators = cvt_node_list(cvt, gc, hermes_get_ClassProperty_decorators(n));
            ...
            let type_annotation =
                cvt_node_ptr_opt(cvt, gc, hermes_get_ClassProperty_typeAnnotation(n));
        ...
        NodeKind::ClassPrivateProperty => {
            ...
            let decorators = cvt_node_list(cvt, gc, hermes_get_ClassPrivateProperty_decorators(n));
            ...
            let type_annotation =
                cvt_node_ptr_opt(cvt, gc, hermes_get_ClassPrivateProperty_typeAnnotation(n));
            let ts_modifiers =
                cvt_node_ptr_opt(cvt, gc, hermes_get_ClassPrivateProperty_tsModifiers(n));
        ...
        NodeKind::MethodDefinition => {
            ...
            let decorators = cvt_node_list(cvt, gc, hermes_get_MethodDefinition_decorators(n));
        ...
        NodeKind::ImportDeclaration => {
            ...
            let attributes = cvt_node_list_opt(cvt, gc, hermes_get_ImportDeclaration_attributes(n));
        ...
        NodeKind::ExportNamedDeclaration => {
            let declaration =
                cvt_node_ptr_opt(cvt, gc, hermes_get_ExportNamedDeclaration_declaration(n));
            let specifiers =
                cvt_node_list(cvt, gc, hermes_get_ExportNamedDeclaration_specifiers(n));
        ...
        NodeKind::ExportDefaultDeclaration => {
            let declaration =
                cvt_node_ptr(cvt, gc, hermes_get_ExportDefaultDeclaration_declaration(n));
        ...
        NodeKind::ObjectPattern => {
            ...
            let type_annotation =
                cvt_node_ptr_opt(cvt, gc, hermes_get_ObjectPattern_typeAnnotation(n));
        ...
        NodeKind::ArrayPattern => {
            ...
            let type_annotation =
                cvt_node_ptr_opt(cvt, gc, hermes_get_ArrayPattern_typeAnnotation(n));
        ...
        NodeKind::MatchInstancePattern => {
            let target_constructor = cvt_node_ptr(
                cvt,
                gc,
                hermes_get_MatchInstancePattern_targetConstructor(n),
            );
            let properties = cvt_node_ptr(cvt, gc, hermes_get_MatchInstancePattern_properties(n));
            let mut template = ast::template::MatchInstancePattern {
                metadata: ast::TemplateMetadata {
                    range,
                    ..Default::default()
                },
            ...
            ast::builder::MatchInstancePattern::build_template(gc, template)
        }
        ...
        NodeKind::MatchInstanceObjectPattern => {
            let properties =
                cvt_node_list(cvt, gc, hermes_get_MatchInstanceObjectPattern_properties(n));
            let rest = cvt_node_ptr_opt(cvt, gc, hermes_get_MatchInstanceObjectPattern_rest(n));
            let mut template = ast::template::MatchInstanceObjectPattern {
                metadata: ast::TemplateMetadata {
                    range,
                    ..Default::default()
                },
            ...
            ast::builder::MatchInstanceObjectPattern::build_template(gc, template)
        }
        ...
        NodeKind::JSXOpeningElement => {
            ...
            let type_arguments =
                cvt_node_ptr_opt(cvt, gc, hermes_get_JSXOpeningElement_typeArguments(n));
        ...
        NodeKind::JSXElement => {
            ...
            let closing_element =
                cvt_node_ptr_opt(cvt, gc, hermes_get_JSXElement_closingElement(n));
        ...
        NodeKind::UndefinedTypeAnnotation => {
            let mut template = ast::template::UndefinedTypeAnnotation {
                metadata: ast::TemplateMetadata {
                    range,
                    ..Default::default()
                },
            ...
            ast::builder::UndefinedTypeAnnotation::build_template(gc, template)
        }
        NodeKind::FunctionTypeAnnotation => {
            ...
            let return_type =
                cvt_node_ptr(cvt, gc, hermes_get_FunctionTypeAnnotation_returnType(n));
            let rest = cvt_node_ptr_opt(cvt, gc, hermes_get_FunctionTypeAnnotation_rest(n));
            let type_parameters =
                cvt_node_ptr_opt(cvt, gc, hermes_get_FunctionTypeAnnotation_typeParameters(n));
        ...
        NodeKind::HookTypeAnnotation => {
            ...
            let type_parameters =
                cvt_node_ptr_opt(cvt, gc, hermes_get_HookTypeAnnotation_typeParameters(n));
        ...
        NodeKind::FunctionTypeParam => {
            ...
            let type_annotation =
                cvt_node_ptr(cvt, gc, hermes_get_FunctionTypeParam_typeAnnotation(n));
        ...
        NodeKind::ComponentTypeAnnotation => {
            ...
            let type_parameters = cvt_node_ptr_opt(
                cvt,
                gc,
                hermes_get_ComponentTypeAnnotation_typeParameters(n),
            );
            let renders_type =
                cvt_node_ptr_opt(cvt, gc, hermes_get_ComponentTypeAnnotation_rendersType(n));
        ...
        NodeKind::ComponentTypeParameter => {
            ...
            let type_annotation =
                cvt_node_ptr(cvt, gc, hermes_get_ComponentTypeParameter_typeAnnotation(n));
        ...
        NodeKind::NullableTypeAnnotation => {
            let type_annotation =
                cvt_node_ptr(cvt, gc, hermes_get_NullableTypeAnnotation_typeAnnotation(n));
        ...
        NodeKind::QualifiedTypeIdentifier => {
            let qualification =
                cvt_node_ptr(cvt, gc, hermes_get_QualifiedTypeIdentifier_qualification(n));
        ...
        NodeKind::TypeofTypeAnnotation => {
            ...
            let type_arguments =
                cvt_node_ptr_opt(cvt, gc, hermes_get_TypeofTypeAnnotation_typeArguments(n));
        ...
        NodeKind::QualifiedTypeofIdentifier => {
            let qualification = cvt_node_ptr(
                cvt,
                gc,
                hermes_get_QualifiedTypeofIdentifier_qualification(n),
            );
        ...
        NodeKind::TupleTypeAnnotation => {
            let element_types =
                cvt_node_list(cvt, gc, hermes_get_TupleTypeAnnotation_elementTypes(n));
        ...
        NodeKind::TupleTypeSpreadElement => {
            ...
            let type_annotation =
                cvt_node_ptr(cvt, gc, hermes_get_TupleTypeSpreadElement_typeAnnotation(n));
        ...
        NodeKind::TupleTypeLabeledElement => {
            ...
            let element_type =
                cvt_node_ptr(cvt, gc, hermes_get_TupleTypeLabeledElement_elementType(n));
            let optional = hermes_get_TupleTypeLabeledElement_optional(n);
            let variance =
                cvt_node_ptr_opt(cvt, gc, hermes_get_TupleTypeLabeledElement_variance(n));
        ...
        NodeKind::InferTypeAnnotation => {
            let type_parameter =
                cvt_node_ptr(cvt, gc, hermes_get_InferTypeAnnotation_typeParameter(n));
        ...
        NodeKind::GenericTypeAnnotation => {
            ...
            let type_parameters =
                cvt_node_ptr_opt(cvt, gc, hermes_get_GenericTypeAnnotation_typeParameters(n));
        ...
        NodeKind::OptionalIndexedAccessType => {
            let object_type =
                cvt_node_ptr(cvt, gc, hermes_get_OptionalIndexedAccessType_objectType(n));
            let index_type =
                cvt_node_ptr(cvt, gc, hermes_get_OptionalIndexedAccessType_indexType(n));
        ...
        NodeKind::ConditionalTypeAnnotation => {
            let check_type =
                cvt_node_ptr(cvt, gc, hermes_get_ConditionalTypeAnnotation_checkType(n));
            let extends_type =
                cvt_node_ptr(cvt, gc, hermes_get_ConditionalTypeAnnotation_extendsType(n));
            let true_type = cvt_node_ptr(cvt, gc, hermes_get_ConditionalTypeAnnotation_trueType(n));
            let false_type =
                cvt_node_ptr(cvt, gc, hermes_get_ConditionalTypeAnnotation_falseType(n));
        ...
        NodeKind::TypePredicate => {
            ...
            let type_annotation =
                cvt_node_ptr_opt(cvt, gc, hermes_get_TypePredicate_typeAnnotation(n));
        ...
        NodeKind::OpaqueType => {
            ...
            let type_parameters =
                cvt_node_ptr_opt(cvt, gc, hermes_get_OpaqueType_typeParameters(n));
            let impltype = cvt_node_ptr(cvt, gc, hermes_get_OpaqueType_impltype(n));
            let lower_bound = cvt_node_ptr_opt(cvt, gc, hermes_get_OpaqueType_lowerBound(n));
            let upper_bound = cvt_node_ptr_opt(cvt, gc, hermes_get_OpaqueType_upperBound(n));
        ...
        NodeKind::InterfaceDeclaration => {
            ...
            let type_parameters =
                cvt_node_ptr_opt(cvt, gc, hermes_get_InterfaceDeclaration_typeParameters(n));
        ...
        NodeKind::DeclareTypeAlias => {
            ...
            let type_parameters =
                cvt_node_ptr_opt(cvt, gc, hermes_get_DeclareTypeAlias_typeParameters(n));
        ...
        NodeKind::DeclareOpaqueType => {
            ...
            let type_parameters =
                cvt_node_ptr_opt(cvt, gc, hermes_get_DeclareOpaqueType_typeParameters(n));
            let impltype = cvt_node_ptr_opt(cvt, gc, hermes_get_DeclareOpaqueType_impltype(n));
            let lower_bound = cvt_node_ptr_opt(cvt, gc, hermes_get_DeclareOpaqueType_lowerBound(n));
            let upper_bound = cvt_node_ptr_opt(cvt, gc, hermes_get_DeclareOpaqueType_upperBound(n));
        ...
        NodeKind::DeclareInterface => {
            ...
            let type_parameters =
                cvt_node_ptr_opt(cvt, gc, hermes_get_DeclareInterface_typeParameters(n));
        ...
        NodeKind::DeclareClass => {
            ...
            let type_parameters =
                cvt_node_ptr_opt(cvt, gc, hermes_get_DeclareClass_typeParameters(n));
        ...
        NodeKind::DeclareComponent => {
            ...
            let type_parameters =
                cvt_node_ptr_opt(cvt, gc, hermes_get_DeclareComponent_typeParameters(n));
            let renders_type =
                cvt_node_ptr_opt(cvt, gc, hermes_get_DeclareComponent_rendersType(n));
        ...
        NodeKind::DeclareExportDeclaration => {
            let declaration =
                cvt_node_ptr_opt(cvt, gc, hermes_get_DeclareExportDeclaration_declaration(n));
            let specifiers =
                cvt_node_list(cvt, gc, hermes_get_DeclareExportDeclaration_specifiers(n));
        ...
        NodeKind::DeclareModuleExports => {
            let type_annotation =
                cvt_node_ptr(cvt, gc, hermes_get_DeclareModuleExports_typeAnnotation(n));
        ...
        NodeKind::InterfaceExtends => {
            ...
            let type_parameters =
                cvt_node_ptr_opt(cvt, gc, hermes_get_InterfaceExtends_typeParameters(n));
        ...
        NodeKind::ClassImplements => {
            ...
            let type_parameters =
                cvt_node_ptr_opt(cvt, gc, hermes_get_ClassImplements_typeParameters(n));
        ...
        NodeKind::TypeAnnotation => {
            let type_annotation =
                cvt_node_ptr(cvt, gc, hermes_get_TypeAnnotation_typeAnnotation(n));
        ...
        NodeKind::ObjectTypeAnnotation => {
            ...
            let call_properties =
                cvt_node_list(cvt, gc, hermes_get_ObjectTypeAnnotation_callProperties(n));
            let internal_slots =
                cvt_node_list(cvt, gc, hermes_get_ObjectTypeAnnotation_internalSlots(n));
        ...
        NodeKind::ObjectTypeMappedTypeProperty => {
            let key_tparam = cvt_node_ptr(
                cvt,
                gc,
                hermes_get_ObjectTypeMappedTypeProperty_keyTparam(n),
            );
            let prop_type =
                cvt_node_ptr(cvt, gc, hermes_get_ObjectTypeMappedTypeProperty_propType(n));
            let source_type = cvt_node_ptr(
                cvt,
                gc,
                hermes_get_ObjectTypeMappedTypeProperty_sourceType(n),
            );
            let variance =
                cvt_node_ptr_opt(cvt, gc, hermes_get_ObjectTypeMappedTypeProperty_variance(n));
            let optional =
                cvt.cvt_string_opt(gc, hermes_get_ObjectTypeMappedTypeProperty_optional(n));
        ...
        NodeKind::TypeCastExpression => {
            ...
            let type_annotation =
                cvt_node_ptr(cvt, gc, hermes_get_TypeCastExpression_typeAnnotation(n));
        ...
        NodeKind::RecordDeclaration => {
            let id = cvt_node_ptr(cvt, gc, hermes_get_RecordDeclaration_id(n));
            let type_parameters =
                cvt_node_ptr_opt(cvt, gc, hermes_get_RecordDeclaration_typeParameters(n));
            let implements = cvt_node_list(cvt, gc, hermes_get_RecordDeclaration_implements(n));
            let body = cvt_node_ptr(cvt, gc, hermes_get_RecordDeclaration_body(n));
            let mut template = ast::template::RecordDeclaration {
                metadata: ast::TemplateMetadata {
                    range,
                    ..Default::default()
                },
            ...
            ast::builder::RecordDeclaration::build_template(gc, template)
        }
        NodeKind::RecordDeclarationImplements => {
            let id = cvt_node_ptr(cvt, gc, hermes_get_RecordDeclarationImplements_id(n));
            let type_arguments = cvt_node_ptr_opt(
                cvt,
                gc,
                hermes_get_RecordDeclarationImplements_typeArguments(n),
            );
            let mut template = ast::template::RecordDeclarationImplements {
                metadata: ast::TemplateMetadata {
                    range,
                    ..Default::default()
                },
            ...
            ast::builder::RecordDeclarationImplements::build_template(gc, template)
        }
        NodeKind::RecordDeclarationBody => {
            let elements = cvt_node_list(cvt, gc, hermes_get_RecordDeclarationBody_elements(n));
            let mut template = ast::template::RecordDeclarationBody {
                metadata: ast::TemplateMetadata {
                    range,
                    ..Default::default()
                },
            ...
            ast::builder::RecordDeclarationBody::build_template(gc, template)
        }
        NodeKind::RecordDeclarationProperty => {
            let key = cvt_node_ptr(cvt, gc, hermes_get_RecordDeclarationProperty_key(n));
            let type_annotation = cvt_node_ptr(
                cvt,
                gc,
                hermes_get_RecordDeclarationProperty_typeAnnotation(n),
            );
            let default_value = cvt_node_ptr_opt(
                cvt,
                gc,
                hermes_get_RecordDeclarationProperty_defaultValue(n),
            );
            let mut template = ast::template::RecordDeclarationProperty {
                metadata: ast::TemplateMetadata {
                    range,
                    ..Default::default()
                },
            ...
            ast::builder::RecordDeclarationProperty::build_template(gc, template)
        }
        NodeKind::RecordDeclarationStaticProperty => {
            let key = cvt_node_ptr(cvt, gc, hermes_get_RecordDeclarationStaticProperty_key(n));
            let type_annotation = cvt_node_ptr(
                cvt,
                gc,
                hermes_get_RecordDeclarationStaticProperty_typeAnnotation(n),
            );
            let value = cvt_node_ptr(cvt, gc, hermes_get_RecordDeclarationStaticProperty_value(n));
            let mut template = ast::template::RecordDeclarationStaticProperty {
                metadata: ast::TemplateMetadata {
                    range,
                    ..Default::default()
                },
            ...
            ast::builder::RecordDeclarationStaticProperty::build_template(gc, template)
        }
        NodeKind::RecordExpression => {
            let record_constructor =
                cvt_node_ptr(cvt, gc, hermes_get_RecordExpression_recordConstructor(n));
            let type_arguments =
                cvt_node_ptr_opt(cvt, gc, hermes_get_RecordExpression_typeArguments(n));
            let properties = cvt_node_ptr(cvt, gc, hermes_get_RecordExpression_properties(n));
            let mut template = ast::template::RecordExpression {
                metadata: ast::TemplateMetadata {
                    range,
                    ..Default::default()
                },
            ...
            ast::builder::RecordExpression::build_template(gc, template)
        }
        NodeKind::RecordExpressionProperties => {
            let properties =
                cvt_node_list(cvt, gc, hermes_get_RecordExpressionProperties_properties(n));
            let mut template = ast::template::RecordExpressionProperties {
                metadata: ast::TemplateMetadata {
                    range,
                    ..Default::default()
                },
            ...
            ast::builder::RecordExpressionProperties::build_template(gc, template)
        }
        NodeKind::TSTypeAnnotation => {
            let type_annotation =
                cvt_node_ptr(cvt, gc, hermes_get_TSTypeAnnotation_typeAnnotation(n));
        ...
        NodeKind::TSTypeReference => {
            ...
            let type_parameters =
                cvt_node_ptr_opt(cvt, gc, hermes_get_TSTypeReference_typeParameters(n));
        ...
        NodeKind::TSFunctionType => {
            ...
            let type_parameters =
                cvt_node_ptr_opt(cvt, gc, hermes_get_TSFunctionType_typeParameters(n));
        ...
        NodeKind::TSConstructorType => {
            ...
            let type_parameters =
                cvt_node_ptr_opt(cvt, gc, hermes_get_TSConstructorType_typeParameters(n));
        ...
        NodeKind::TSTypePredicate => {
            ...
            let type_annotation =
                cvt_node_ptr(cvt, gc, hermes_get_TSTypePredicate_typeAnnotation(n));
        ...
        NodeKind::TSTypeAssertion => {
            let type_annotation =
                cvt_node_ptr(cvt, gc, hermes_get_TSTypeAssertion_typeAnnotation(n));
        ...
        NodeKind::TSAsExpression => {
            ...
            let type_annotation =
                cvt_node_ptr(cvt, gc, hermes_get_TSAsExpression_typeAnnotation(n));
        ...
        NodeKind::TSParameterProperty => {
            ...
            let accessibility =
                cvt.cvt_label_opt(gc, hermes_get_TSParameterProperty_accessibility(n));
        ...
        NodeKind::TSTypeAliasDeclaration => {
            ...
            let type_parameters =
                cvt_node_ptr_opt(cvt, gc, hermes_get_TSTypeAliasDeclaration_typeParameters(n));
            let type_annotation =
                cvt_node_ptr(cvt, gc, hermes_get_TSTypeAliasDeclaration_typeAnnotation(n));
        ...
        NodeKind::TSInterfaceDeclaration => {
            ...
            let type_parameters =
                cvt_node_ptr_opt(cvt, gc, hermes_get_TSInterfaceDeclaration_typeParameters(n));
        ...
        NodeKind::TSInterfaceHeritage => {
            ...
            let type_parameters =
                cvt_node_ptr_opt(cvt, gc, hermes_get_TSInterfaceHeritage_typeParameters(n));
        ...
        NodeKind::TSPropertySignature => {
            ...
            let type_annotation =
                cvt_node_ptr_opt(cvt, gc, hermes_get_TSPropertySignature_typeAnnotation(n));
            let initializer =
                cvt_node_ptr_opt(cvt, gc, hermes_get_TSPropertySignature_initializer(n));
        ...
        NodeKind::TSIndexSignature => {
            ...
            let type_annotation =
                cvt_node_ptr_opt(cvt, gc, hermes_get_TSIndexSignature_typeAnnotation(n));
        ...
        NodeKind::TSCallSignatureDeclaration => {
            ...
            let return_type =
                cvt_node_ptr_opt(cvt, gc, hermes_get_TSCallSignatureDeclaration_returnType(n));
        ...
        NodeKind::SHBuiltin => {
            let mut template = ast::template::SHBuiltin {
                metadata: ast::TemplateMetadata {
                    range,
                    ..Default::default()
                },
            ...
            ast::builder::SHBuiltin::build_template(gc, template)
        }
        NodeKind::ImplicitCheckedCast => {
            let argument = cvt_node_ptr(cvt, gc, hermes_get_ImplicitCheckedCast_argument(n));
            let mut template = ast::template::ImplicitCheckedCast {
                metadata: ast::TemplateMetadata {
                    range,
                    ..Default::default()
                },
            ...
            ast::builder::ImplicitCheckedCast::build_template(gc, template)
        }
        _ => {
