  ...
  n: NodePtr) -> &'gc ast::Node<'gc> {
    ...
    let res = match nr.kind {
        ...
        NodeKind::ClassDeclaration => {
          ...
          let super_type_parameters = cvt_node_ptr_opt(cvt, gc, hermes_get_ClassDeclaration_superTypeArguments(n));
        ...
        NodeKind::ClassExpression => {
          ...
          let super_type_parameters = cvt_node_ptr_opt(cvt, gc, hermes_get_ClassExpression_superTypeArguments(n));
